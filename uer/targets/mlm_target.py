...
class RelMlmTarget(nn.Module):
    ...
    def __init__(self, args, vocab_size):
        super(RelMlmTarget, self).__init__()
        self.vocab_size = vocab_size
        self.hidden_size = args.hidden_size
...
class EntMlmTarget(nn.Module):
    ...
    def __init__(self, args, vocab_size):
        super(EntMlmTarget, self).__init__()
        self.vocab_size = vocab_size
        self.hidden_size = args.hidden_size
